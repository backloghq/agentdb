...
**Status: v2.2.0-dev — all v2.1.1 capabilities plus bloom filter query planner integration (short-circuit on definite-miss), `HnswOptions.persistEvery` for bounded crash exposure (periodic full-graph flush), and efSearch recall differential test.**
